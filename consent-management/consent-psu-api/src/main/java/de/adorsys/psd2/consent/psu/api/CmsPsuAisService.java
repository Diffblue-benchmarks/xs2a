...
public interface CmsPsuAisService {
     ...
     * @param instanceId         optional ID of particular service instance
     * @param authenticationData optional parameter for online-banking, chosen method ID and authentication data
     * @return <code>true</code> if consent was found and status was updated. <code>false</code> otherwise.
     */
    boolean updateAuthorisationStatus(@NotNull PsuIdData psuIdData, @NotNull String consentId, @NotNull String authorisationId, @NotNull ScaStatus status, @NotNull String instanceId, AuthenticationData authenticationData) throws AuthorisationIsExpiredException;
