...
public interface CmsPsuPisService {
     ...
     */
    boolean updateAuthorisationStatus(@NotNull PsuIdData psuIdData, @NotNull String paymentId, @NotNull String authorisationId, @NotNull ScaStatus status, @NotNull String instanceId, AuthenticationData authenticationData) throws AuthorisationIsExpiredException;
