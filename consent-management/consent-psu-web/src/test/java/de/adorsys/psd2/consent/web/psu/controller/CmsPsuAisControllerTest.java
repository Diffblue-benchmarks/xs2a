...
public class CmsPsuAisControllerTest {
    ...
    public void updateAuthorisationStatus_withValidRequest_shouldReturnOk() throws AuthorisationIsExpiredException {
        // Given
        when(cmsPsuAisService.updateAuthorisationStatus(psuIdData, CONSENT_ID, AUTHORISATION_ID, ScaStatus.RECEIVED, INSTANCE_ID, authenticationData))
            .thenReturn(true);

        // When
        ResponseEntity actualResponse = cmsPsuAisController.updateAuthorisationStatus(CONSENT_ID, SCA_STATUS_RECEIVED, AUTHORISATION_ID, PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, INSTANCE_ID, authenticationData);

        // Then
        verify(cmsPsuAisService).updateAuthorisationStatus(psuIdData, CONSENT_ID, AUTHORISATION_ID, ScaStatus.RECEIVED, INSTANCE_ID, authenticationData);
    ...
    public void updateAuthorisationStatus_withValidRequestAndLowercaseScaStatus_shouldReturnOk() throws AuthorisationIsExpiredException {
        ...
        // When
        ResponseEntity actualResponse = cmsPsuAisController.updateAuthorisationStatus(CONSENT_ID, lowercaseScaStatus, AUTHORISATION_ID, PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, INSTANCE_ID, authenticationData);
    ...
    public void updateAuthorisationStatus_withInvalidScaStatus_shouldReturnBadRequest() throws AuthorisationIsExpiredException {
        ...
        // When
        ResponseEntity actualResponse = cmsPsuAisController.updateAuthorisationStatus(CONSENT_ID, invalidScaStatus, AUTHORISATION_ID, PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, INSTANCE_ID, authenticationData);
    ...
    public void updateAuthorisationStatus_withExpiredAuthorisation_shouldReturnRequestTimeout() throws AuthorisationIsExpiredException {
        ...
        // When
        ResponseEntity<CmsAisConsentResponse> actualResponse = cmsPsuAisController.updateAuthorisationStatus(CONSENT_ID, SCA_STATUS_RECEIVED, AUTHORISATION_ID, PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, INSTANCE_ID, authenticationData);
