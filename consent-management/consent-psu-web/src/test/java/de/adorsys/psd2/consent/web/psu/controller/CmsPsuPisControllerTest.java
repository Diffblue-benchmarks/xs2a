...
public class CmsPsuPisControllerTest {
    ...
    @Before
    public void init() {
        authenticationData = new AuthenticationData(METHOD_ID, AUTHENTICATION_DATA);
    }
    ...
    public void updateAuthorisationStatus_withValidRequest_shouldReturnOk() throws AuthorisationIsExpiredException {
        ...
        when(cmsPsuPisService.updateAuthorisationStatus(psuIdData, PAYMENT_ID, AUTHORISATION_ID, ScaStatus.RECEIVED, INSTANCE_ID, authenticationData))
            .thenReturn(true);

        // When
        ResponseEntity<Void> actualResponse = cmsPsuPisController.updateAuthorisationStatus(PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, PAYMENT_ID, AUTHORISATION_ID, SCA_STATUS_RECEIVED, INSTANCE_ID, authenticationData);

        // Then
        verify(cmsPsuPisService).updateAuthorisationStatus(psuIdData, PAYMENT_ID, AUTHORISATION_ID, ScaStatus.RECEIVED, INSTANCE_ID, authenticationData);
    ...
    public void updateAuthorisationStatus_withValidRequestAndLowercaseScaStatus_shouldReturnOk() throws AuthorisationIsExpiredException {
        ...
        // When
        ResponseEntity<Void> actualResponse = cmsPsuPisController.updateAuthorisationStatus(PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, PAYMENT_ID, AUTHORISATION_ID, lowercaseScaStatus, INSTANCE_ID, authenticationData);
    ...
    public void updateAuthorisationStatus_AuthorisationIsExpired_requestTimeout() throws AuthorisationIsExpiredException {
        ...
        // When
        ResponseEntity<CmsPaymentResponse> actualResponse = cmsPsuPisController.updateAuthorisationStatus(PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, PAYMENT_ID, AUTHORISATION_ID, SCA_STATUS_RECEIVED, INSTANCE_ID, authenticationData);

        // Then
        verify(cmsPsuPisService, times(1)).updateAuthorisationStatus(psuIdData, PAYMENT_ID, AUTHORISATION_ID, ScaStatus.RECEIVED, INSTANCE_ID, authenticationData);
    ...
    public void updateAuthorisationStatus_withInvalidScaStatus_shouldReturnBadRequest() throws AuthorisationIsExpiredException {
        ...
        // When
        ResponseEntity<Void> actualResponse = cmsPsuPisController.updateAuthorisationStatus(PSU_ID, PSU_ID_TYPE, PSU_CORPORATE_ID, PSU_CORPORATE_ID_TYPE, PAYMENT_ID, AUTHORISATION_ID, invalidScaStatus, INSTANCE_ID, authenticationData);
