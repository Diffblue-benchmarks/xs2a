...
public class RequestProviderServiceTest {
    ...
    private static final String AUTHORISATION = "Bearer 111111";
    ...
    public void getAuthorisation() {
        // When
        String actualAuthorisationHeader = requestProviderService.getAuthorisation();

        // Then
        assertEquals(AUTHORISATION, actualAuthorisationHeader);
    }
